...
$.jribbble.users('josiahkatz').shots({per_page: 12}).then(function(shots) {
  var html = [];
  
  var list = $('.shots-list');

  shots.forEach(function(shot) {
    html.push('<li class="shots-item"><a href="' + shot.html_url + '" class="shot" target="blank"><img src="' + shot.images.normal + '"/></a></li>');
  });
